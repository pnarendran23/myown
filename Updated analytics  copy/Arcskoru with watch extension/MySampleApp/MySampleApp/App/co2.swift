...
class co2: UIView {
    ...
    override init(frame: CGRect) {
        ...
        data = NSUserDefaults.standardUserDefaults().objectForKey("co2") as! [Int]
        if(data2.count==0){
    ...
    func setupLayers(){
        ...
        if(NSUserDefaults.standardUserDefaults().objectForKey("startdateforco2") != nil){
            var startdate = NSUserDefaults.standardUserDefaults().objectForKey("startdateforco2") as! NSDate
            var enddate = NSUserDefaults.standardUserDefaults().objectForKey("enddateforco2") as! NSDate
    ...
    func setupLayerFrames(){
        ...
        if let durationtext : CATextLayer = layers["durationtext"] as? CATextLayer{
            durationtext.frame = CGRectMake(0.1601 * durationtext.superlayer!.bounds.width, 0.85312 * durationtext.superlayer!.bounds.height, 0.7426 * durationtext.superlayer!.bounds.width, 0.05 * durationtext.superlayer!.bounds.height)
