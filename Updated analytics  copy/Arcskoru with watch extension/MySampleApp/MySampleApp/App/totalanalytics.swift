...
class totalanalytics: UIViewController, UITableViewDataSource, UITableViewDelegate, UITabBarDelegate,WCSessionDelegate, UIGestureRecognizerDelegate {
    ...
    @IBOutlet weak var decvv: UIView!
   ...
   /* override func supportedInterfaceOrientations() -> UIInterfaceOrientationMask {
    ...
    override func viewDidLoad() {
        ...
        tableview.registerNib(UINib.init(nibName: "row4", bundle: nil), forCellReuseIdentifier: "row4")
        tableview.registerNib(UINib.init(nibName: "row5", bundle: nil), forCellReuseIdentifier: "row5")
        self.titlefont()
        self.automaticallyAdjustsScrollViewInsets = false;
...
NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(self.adjustwidth), name: UIDeviceOrientationDidChangeNotification, object: nil)
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        if(indexPath.section == 0){
           ...
           // cell.gross.text = String(format: "%d Sq.Ft",buildingdetails["gross_area"] as! Int)
            ...
            let cell = tableview.dequeueReusableCellWithIdentifier("row4")! as! row4
            ...
            tempostring.addAttribute(NSFontAttributeName, value: UIFont.init(name: "OpenSans-Bold", size: 20)! , range: NSMakeRange(0, tempostring.length))
            tempostring.addAttribute(NSForegroundColorAttributeName, value: UIColor.blackColor(), range: NSMakeRange(0, tempostring.length))
            actualstring.appendAttributedString(tempostring.mutableCopy() as! NSAttributedString)
            tempostring.deleteCharactersInRange(NSMakeRange(0, tempostring.length))
            ...
            tempostring.addAttribute(NSFontAttributeName, value: UIFont.init(name: "OpenSans", size: 20)! , range: NSMakeRange(0, tempostring.length))
            actualstring.appendAttributedString(tempostring.mutableCopy() as! NSAttributedString)
            //print(actualstring)
            ...
            if(indexPath.section == 8){
                if(indexPath.row == 0){
                    let cell = tableView.dequeueReusableCellWithIdentifier("row5",forIndexPath: indexPath) as! row5
                    var string1arr = [String]()
                    var string2arr = [String]()
                    string1arr.append("TOTAL ANNUAL CARBON EMISSIONS (MTCO2e)")
                    string2arr.append(String(format: "%.4f",totalannumarr.objectAtIndex(0) as! Double))
                    cell.textLabel?.numberOfLines = 2
                    cell.clipsToBounds = true
      
                    string1arr.append("TOTAL DAILY CARBON EMISSIONS (MTCO2e)")
                    string2arr.append(String(format: "%.4f",totaldailyarr.objectAtIndex(0) as! Double))
                    cell.textLabel?.numberOfLines = 2
                    cell.clipsToBounds = true

                    string1arr.append("ENERGY ANNUAL SCOPE 1 CARBON EMISSIONS (MTCO2e)")
                    string2arr.append(String(format: "%.4f",scope1annumarr.objectAtIndex(0) as! Double))
                    cell.textLabel?.numberOfLines = 2
                    cell.clipsToBounds = true
  
                    string1arr.append("ENERGY DAILY SCOPE 1 CARBON EMISSIONS (MTCO2e)")
                    string2arr.append(String(format: "%.4f",scope1dailyarr.objectAtIndex(0) as! Double))
                    cell.textLabel?.numberOfLines = 2
                    cell.clipsToBounds = true
  
                    string1arr.append("ENERGY ANNUAL SCOPE 2 CARBON EMISSIONS (MTCO2e)")
                    string2arr.append(String(format: "%.4f",scope2annumarr.objectAtIndex(0) as! Double))
                    cell.textLabel?.numberOfLines = 2
                    cell.clipsToBounds = true

                    string1arr.append("ENERGY DAILY SCOPE 2 CARBON EMISSIONS (MTCO2e)")
                    string2arr.append(String(format: "%.4f",scope2dailyarr.objectAtIndex(0) as! Double))
                    cell.textLabel?.numberOfLines = 2
                    cell.clipsToBounds = true
 
                    string1arr.append("TRANSPORTATION ANNUAL CARBON EMISSIONS (MTCO2e)")
                    string2arr.append(String(format: "%.4f",transitannumarr.objectAtIndex(0) as! Double))
                    cell.clipsToBounds = true

                    string1arr.append("TRANSPORTATION DAILY CARBON EMISSIONS (MTCO2e)")
                    string2arr.append(String(format: "%.4f",transitdailyarr.objectAtIndex(0) as! Double))
                    cell.textLabel?.numberOfLines = 2
                    cell.clipsToBounds = true
   
                    string1arr.append("TOTAL ANNUAL CARBON EMISSIONS (MTCO2e) - PER SQ FT")
                    string2arr.append(String(format: "%.4f",totalannumarr.objectAtIndex(1) as! Double))
                    cell.textLabel?.numberOfLines = 2
                    cell.clipsToBounds = true
   
                    string1arr.append("TOTAL DAILY CARBON EMISSIONS (MTCO2e) - PER SQ FT")
                    string2arr.append(String(format: "%.4f",totaldailyarr.objectAtIndex(1) as! Double))
                    cell.textLabel?.numberOfLines = 2
                    cell.clipsToBounds = true
  
                    string1arr.append("ENERGY ANNUAL SCOPE 1 CARBON EMISSIONS (MTCO2e) - PER SQ FT")
                    string2arr.append(String(format: "%.4f",scope1annumarr.objectAtIndex(1) as! Double))
                    cell.textLabel?.numberOfLines = 2
                    cell.clipsToBounds = true
 
                    string1arr.append("ENERGY DAILY SCOPE 1 CARBON EMISSIONS (MTCO2e) - PER SQ FT")
                    string2arr.append(String(format: "%.4f",scope1dailyarr.objectAtIndex(1) as! Double))
                    cell.textLabel?.numberOfLines = 2
                    cell.clipsToBounds = true
    
                    string1arr.append("ENERGY ANNUAL SCOPE 2 CARBON EMISSIONS (MTCO2e) - PER SQ FT")
                    string2arr.append(String(format: "%.4f",scope2annumarr.objectAtIndex(1) as! Double))
                    cell.textLabel?.numberOfLines = 2
                    cell.clipsToBounds = true
   
                    string1arr.append("ENERGY DAILY SCOPE 2 CARBON EMISSIONS (MTCO2e) - PER SQ FT")
                    string2arr.append(String(format: "%.4f",scope2dailyarr.objectAtIndex(1) as! Double))
                    cell.textLabel?.numberOfLines = 2
                    cell.clipsToBounds = true
   
                    string1arr.append("TRANSPORTATION ANNUAL CARBON EMISSIONS (MTCO2e) - PER SQ FT")
                    string2arr.append("-")//String(format: "%.4f",transitannumarr.objectAtIndex(1) as! Double))
                    cell.textLabel?.numberOfLines = 2
                    cell.clipsToBounds = true
 
                    string1arr.append("TRANSPORTATION DAILY CARBON EMISSIONS (MTCO2e) - PER SQ FT")
                    string2arr.append("-")//String(format: "%.4f",transitdailyarr.objectAtIndex(1) as! Double))
                    cell.textLabel?.numberOfLines = 2
                    cell.clipsToBounds = true
 
                    string1arr.append("TOTAL ANNUAL CARBON EMISSIONS (MTCO2e) - PER OCC")
                    string2arr.append(String(format: "%.4f",totalannumarr.objectAtIndex(2) as! Double))
                    cell.textLabel?.numberOfLines = 2
                    cell.clipsToBounds = true
  
                    string1arr.append("TOTAL DAILY CARBON EMISSIONS (MTCO2e) - PER OCC")
                    string2arr.append(String(format: "%.4f",totaldailyarr.objectAtIndex(2) as! Double))
                    
                    cell.textLabel?.numberOfLines = 2
                    cell.clipsToBounds = true

                    string1arr.append("ENERGY ANNUAL SCOPE 1 CARBON EMISSIONS (MTCO2e) - PER OCC")
                    string2arr.append(String(format: "%.4f",scope1annumarr.objectAtIndex(2) as! Double))
                    cell.textLabel?.numberOfLines = 2
                    cell.clipsToBounds = true
  
                    string1arr.append("ENERGY DAILY SCOPE 1 CARBON EMISSIONS (MTCO2e) PER OCC")
                    string2arr.append(String(format: "%.4f",scope1dailyarr.objectAtIndex(2) as! Double))
                    cell.textLabel?.numberOfLines = 2
                    cell.clipsToBounds = true
  
                    string1arr.append("ENERGY ANNUAL SCOPE 2 CARBON EMISSIONS (MTCO2e) - PER OCC")
                    string2arr.append(String(format: "%.4f",scope2annumarr.objectAtIndex(2) as! Double))
                    cell.textLabel?.numberOfLines = 2
                    cell.clipsToBounds = true
 
                    string1arr.append("ENERGY DAILY SCOPE 2 CARBON EMISSIONS (MTCO2e) - PER OCC")
                    string2arr.append(String(format: "%.4f",scope2dailyarr.objectAtIndex(2) as! Double))
                    cell.textLabel?.numberOfLines = 2
                    cell.clipsToBounds = true
  
                    string1arr.append("TRANSPORTATION ANNUAL CARBON EMISSIONS (MTCO2e) - PER OCC")
                    string2arr.append(String(format: "%.4f",transitannumarr.objectAtIndex(2) as! Double))
                    cell.textLabel?.numberOfLines = 2
                    cell.clipsToBounds = true
 
                    string1arr.append("TRANSPORTATION DAILY CARBON EMISSIONS (MTCO2e) - PER OCC")
                    string2arr.append(String(format: "%.4f",transitdailyarr.objectAtIndex(2) as! Double))
                    cell.textLabel?.numberOfLines = 2
                    cell.clipsToBounds = true
                    cell.gameNames = string1arr
                    cell.valuesarr = string2arr
                ...
                for i in 0..<reportedscores.count{
                    ...
                    let tempreportedscores = sortedResults.mutableCopy() as! NSMutableArray
                ...
                if(data.count == 0){
                    ...
                    //print(num)
                    cell.vv.startColor = UIColor.whiteColor()
                    cell.vv.strokecolor = UIColor.init(red: 0.776, green: 0.859, blue: 0.122, alpha: 1)
                    cell.vv.endColor = UIColor.whiteColor()
                    cell.layoutSubviews()
                    ...
                    x.strokecolor = cell.vv.strokecolor
                    ...
                    stringarr1.append("Annual energy consumption (kBTU)")
                    //cell.gameNames = []
                    var temp = energyarr[0] as! NSArray
                    if(temp[0] is Float){
                        stringarr2.append(String(format:"%.5f",Float(temp[0] as! Float) as! Float))
                    }else{
                        stringarr2.append(String(format:"%.5f",Float(temp[0] as! Int) as! Float))
                    }
                    
                    
                    stringarr1.append("DAILY ENERGY CONSUMPTION (kBTU)")
                    temp = energyarr[1] as! NSArray
                    if(temp[0] is Float){
                        stringarr2.append(String(format:"%.5f",Float(temp[0] as! Float) as! Float))
                    }else{
                        stringarr2.append(String(format:"%.5f",Float(temp[0] as! Int) as! Float))
                    ...
                    stringarr1.append("ANNUAL CARBON EMISSIONS (MTCO2e)")
                    temp = energyarr[2] as! NSArray
                    if(temp[0] is Float){
                        stringarr2.append(String(format:"%.5f",Float(temp[0] as! Float) as! Float))
                    }else{
                        stringarr2.append(String(format:"%.5f",Float(temp[0] as! Int) as! Float))
                    ...
                    stringarr1.append("ANNUAL ENERGY CONSUMPTION (kBTU) - PER SQ FT")
                    temp = energyarr[0] as! NSArray
                    if(temp[1] is Float){
                        stringarr2.append(String(format:"%.5f",Float(temp[1] as! Float) as! Float))
                    }else{
                        stringarr2.append(String(format:"%.5f",Float(temp[1] as! Int) as! Float))
                    }
                    ...
                    stringarr1.append("DAILY ENERGY CONSUMPTION (kBTU) - PER SQ FT")
                    
                    stringarr1.append("ANNUAL CARBON EMISSIONS (MTCO2e) - PER SQ FT")
                     temp = energyarr[2] as! NSArray
                    if(temp[1] is Float){
                        stringarr2.append(String(format:"%.5f",Float(temp[1] as! Float) as! Float))
                    }else{
                    ...
                    stringarr1.append("ANNUAL ENERGY CONSUMPTION (kBTU) - PER OCC")
                    temp = energyarr[0] as! NSArray
                    if(temp[2] is Float){
                        stringarr2.append(String(format:"%.5f",Float(temp[2] as! Float) as! Float))
                    }else{
                        stringarr2.append(String(format:"%.5f",Float(temp[2] as! Int) as! Float))
                    }
                    
                    
                    stringarr1.append("DAILY ENERGY CONSUMPTION (kBTU) - PER OCC")
                    temp = energyarr[1] as! NSArray
                    if(temp[2] is Float){
                        stringarr2.append(String(format:"%.5f",Float(temp[2] as! Float) as! Float))
                    }else{
                    ...
                    stringarr1.append("ANNUAL CARBON EMISSIONS (MTCO2e) - PER OCC")
                    temp = energyarr[2] as! NSArray
                    if(temp[2] is Float){
                        stringarr2.append(String(format:"%.5f",Float(temp[2] as! Float) as! Float))
                    }else{
                    ...
                    cell.gameNames = stringarr1
                    cell.valuesarr = stringarr2
                    cell.color = UIColor.init(red: 0.776, green: 0.859, blue: 0.122, alpha: 1)
                    cell.collectionView.reloadData()
                    print(cell.collectionView.contentSize.height,cell.collectionView.frame.size.height)
                    ...
                    cell.vv.endColor = UIColor.init(red: 0.303, green: 0.751, blue: 0.94, alpha: 1)
                            ...
                            cell.vv.startColor = UIColor.whiteColor()
                            cell.vv.strokecolor = UIColor.init(red: 0.303, green: 0.751, blue: 0.94, alpha: 1)
                            cell.vv.endColor = UIColor.whiteColor()
                    ...
                    return cell
                            ...
                            string1arr.append("ANNUAL WATER CONSUMPTION (gal)")
                            var temp = waterarr[0] as! NSArray
                            if(temp[0] is Float){
                                string2arr.append(String(format:"%.5f",Float(temp[0] as! Float) as! Float))
                            }else{
                                string2arr.append(String(format:"%.5f",Float(temp[0] as! Int) as! Float))
                            }
                            cell.textLabel?.numberOfLines = 2
                            cell.clipsToBounds = true
                  
                            
                            string1arr.append("DAILY WATER CONSUMPTION (gal)")
                            temp = waterarr[1] as! NSArray
                            if(temp[0] is Float){
                                string2arr.append(String(format:"%.5f",Float(temp[0] as! Float) as! Float))
                            }else{
                                string2arr.append(String(format:"%.5f",Float(temp[0] as! Int) as! Float))
                            ...
                            string1arr.append("ANNUAL WATER CONSUMPTION (gal) - PER SQ FT")
                            temp = waterarr[0] as! NSArray
                            if(temp[1] is Float){
                                string2arr.append(String(format:"%.5f",Float(temp[1] as! Float) as! Float))
                            }else{
                                string2arr.append(String(format:"%.5f",Float(temp[1] as! Int) as! Float))
                            }
                            cell.textLabel?.numberOfLines = 2
                            cell.clipsToBounds = true
            
                            string1arr.append("DAILY WATER CONSUMPTION (gal) - PER SQ FT")
                            temp = waterarr[1] as! NSArray
                            if(temp[1] is Float){
                                string2arr.append(String(format:"%.5f",Float(temp[1] as! Float) as! Float))
                            }else{
                            ...
                            temp = waterarr[0] as! NSArray
                            if(temp[2] is Float){
                                string2arr.append(String(format:"%.5f",Float(temp[2] as! Float) as! Float))
                            }else{
                                string2arr.append(String(format:"%.5f",Float(temp[2] as! Int) as! Float))
                            }
                            string1arr.append("ANNUAL WATER CONSUMPTION (gal) - PER OCC")
                            cell.textLabel?.numberOfLines = 2
                            cell.clipsToBounds = true
    
                            
                            string1arr.append("DAILY WATER CONSUMPTION (gal) - PER OCC")
                            temp = waterarr[1] as! NSArray
                            if(temp[2] is Float){
                            string2arr.append(String(format:"%.5f",Float(temp[2] as! Float) as! Float))
                            }else{
                            ...
                            cell.gameNames = string1arr
                            cell.valuesarr = string2arr
                            cell.color = UIColor.init(red: 0.303, green: 0.751, blue: 0.94, alpha: 1)
                            cell.collectionView.reloadData()
                ...
                if(indexPath.row == 0){
                    ...
                    cell.vv.startColor = UIColor.whiteColor()
                    cell.vv.strokecolor = UIColor.init(red: 0.461, green: 0.76, blue: 0.629, alpha: 1)
                    cell.vv.endColor = UIColor.whiteColor()
                    ...
                    var string1arr = [String]()
                    var string2arr = [String]()
                    string1arr.append("AVERAGE DAILY WASTE GENERATED (lbs)")
                    ...
                    string1arr.append("AVERAGE DAILY WASTE DIVERTED (lbs)")
                     temp = wastearr[1] as! NSArray
                    if(temp[0] is Float){
                        string2arr.append(String(format:"%.5f",Float(temp[0] as! Float) as! Float))
                    }else{
                        string2arr.append(String(format:"%.5f",Float(temp[0] as! Int) as! Float))
                    ...
                    string1arr.append("AVERAGE DAILY WASTE GENERATED (lbs) - PER SQ FT")
                     temp = wastearr[0] as! NSArray
                    if(temp[1] is Float){
                        string2arr.append(String(format:"%.5f",Float(temp[1] as! Float) as! Float))
                    }else{
                        string2arr.append(String(format:"%.5f",Float(temp[1] as! Int) as! Float))
                    ...
                    string1arr.append("AVERAGE DAILY WASTE DIVERTED (lbs) - PER SQ FT")
                     temp = wastearr[1] as! NSArray
                    if(temp[1] is Float){
                        string2arr.append(String(format:"%.5f",Float(temp[1] as! Float) as! Float))
                    }else{
                    ...
                    string1arr.append("AVERAGE DAILY WASTE GENERATED (lbs) - PER OCC")
                    cell.textLabel?.numberOfLines = 2
                    cell.clipsToBounds = true
                    
                    string1arr.append("AVERAGE DAILY WASTE DIVERTED (lbs) - PER OCC")
                     temp = wastearr[1] as! NSArray
                    if(temp[2] is Float){
                        string2arr.append(String(format:"%.5f",Float(temp[2] as! Float) as! Float))
                    }else{
                    ...
                    cell.gameNames = string1arr
                    cell.valuesarr = string2arr
                    cell.color = UIColor.init(red: 0.461, green: 0.76, blue: 0.629, alpha: 1)
                    cell.collectionView.reloadData()
                    return cell
                ...
                if(indexPath.row == 0){
                    ...
                    cell.vv.startColor = UIColor.whiteColor()
                    cell.vv.strokecolor = UIColor.init(red: 0.572, green: 0.556, blue: 0.505, alpha: 1)
                    cell.vv.endColor = UIColor.whiteColor()
                    ...
                    let cell = tableView.dequeueReusableCellWithIdentifier("row5",forIndexPath: indexPath) as! row5
                        var string1arr = [String]()
                        var string2arr = [String]()
                    string1arr.append("DAILY CARBON EMISSIONS (MTCO2e)")
                    var arr = self.transitarr as! NSArray
                    cell.textLabel?.numberOfLines = 2
                    var f = Float(arr[0].objectAtIndex(0) as! Int)
                    string2arr.append(String(format:"%.2f",f))
  
                        string1arr.append("SURVEY RESPONSE RATE")
                    arr = self.transitarr as! NSArray
                    cell.textLabel?.numberOfLines = 2
                        f = Float(arr[0].objectAtIndex(1) as! Int)
                    string2arr.append(String(format:"%.2f%%",f))
                    cell.clipsToBounds = true

                        string1arr.append("DAILY CARBON EMISSIONS (MTCO2e) - PER OCC ")
                        arr = self.transitarr as! NSArray
                        cell.textLabel?.numberOfLines = 2
                        f = Float(arr[1].objectAtIndex(0) as! Int)
                        string2arr.append(String(format:"%.2f",f))
                        cell.clipsToBounds = true
 
                        string1arr.append("SURVEY RESPONSE RATE - PER OCC")
                        arr = self.transitarr as! NSArray
                        cell.textLabel?.numberOfLines = 2
                        string2arr.append("-")
                        cell.clipsToBounds = true
                        cell.gameNames = string1arr
                        cell.valuesarr = string2arr
                        cell.color = UIColor.init(red: 0.572, green: 0.556, blue: 0.505, alpha: 1)
                        cell.collectionView.reloadData()
                ...
                if(boolarr[indexPath.section] == true){
                 if(indexPath.row == 0){
                    ...
                    var string1arr = [String]()
                    var string2arr = [String]()
                    string1arr.append("INTERIOR CARBON DIOXIDE LEVELS (ppm)")
                    var arr = self.humanarr as! NSArray
                    cell.textLabel?.numberOfLines = 2
                    var f = Float(arr[0].firstObject as! Int)
                    string2arr.append(String(format:"%.2f",f))
                    cell.textLabel!.numberOfLines = 0;
                    cell.textLabel!.lineBreakMode = .ByWordWrapping
                    cell.clipsToBounds = true
     
                    string1arr.append("INTERIOR TOTAL VOLATILE ORGANIC COMPOUND LEVELS (ug/m3)")
                     arr = self.humanarr as! NSArray
                    cell.textLabel?.numberOfLines = 2
                     f = Float(arr[1].firstObject as! Int)
                    string2arr.append(String(format:"%.2f",f))
                    cell.clipsToBounds = true
                    cell.textLabel!.numberOfLines = 0;
                    cell.textLabel!.lineBreakMode = .ByWordWrapping
     
                    string1arr.append("AVERAGE OCCUPANT SATISFACTION")
                    cell.textLabel?.numberOfLines = 2
                     arr = self.humanarr as! NSArray
                     f = Float(arr[2].firstObject as! Int)
                    string2arr.append(String(format:"%.2f",f/100.0))
                    cell.clipsToBounds = true
      
                    string1arr.append("SURVEY RESPONSE RATE")
                    cell.textLabel?.numberOfLines = 2
                     arr = self.humanarr as! NSArray
                     f = Float(arr[3].firstObject as! Int)
                    string2arr.append(String(format:"%.2f%%",f))
                    cell.clipsToBounds = true
                    cell.gameNames = string1arr
                    cell.valuesarr = string2arr
                    cell.color = UIColor.init(red: 0.92, green: 0.609, blue: 0.236, alpha: 1)
                    cell.collectionView.reloadData()
    ...
    func tableView(tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        if(section == 3){
            ...
            var dview = UIView.init(frame: decvv.frame)
            dview.backgroundColor = UIColor.whiteColor()
            vieww.addSubview(dview)
            ...
            actualstring.appendAttributedString(tempostring.mutableCopy() as! NSAttributedString)
            //print(actualstring)
            globalscore.font = UIFont.init(name: "OpenSans", size: 20)
            ...
            actualstring.appendAttributedString(tempostring.mutableCopy() as! NSAttributedString)
            //print(actualstring)
            localscore.font = UIFont.init(name: "OpenSans", size: 20)
            ...
            actualstring.appendAttributedString(tempostring.mutableCopy() as! NSAttributedString)
            //print(actualstring)
            avgscore.font = UIFont.init(name: "OpenSans", size: 20)
            ...
            actualstring.appendAttributedString(tempostring.mutableCopy() as! NSAttributedString)
            //print(actualstring)
            highest.font = UIFont.init(name: "OpenSans", size: 20)
            ...
            actualstring.appendAttributedString(tempostring.mutableCopy() as! NSAttributedString)
            //print(actualstring)
            lowest.font = UIFont.init(name: "OpenSans", size: 20)
            ...
            decorvv.layer.masksToBounds = false
            decorvv.layer.shadowOffset = CGSize(width: 0, height: 8)//Blur
            decorvv.layer.shadowOpacity = 0.30
            decorvv.layer.shadowRadius = 7.0
            ...
            if(boolarr[section] == true){
                innerimage1.image = UIImage.init(named: "less_data")
                
            }else{
                innerimage1.image = UIImage.init(named: "more_data")
            }
    ...
    func handleTap(gestureRecognizer: UIGestureRecognizer) {
        ...
        self.tableview.reloadSections(NSIndexSet.init(index: section), withRowAnimation: UITableViewRowAnimation.None)            
