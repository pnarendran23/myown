...
class manageacity: UIViewController, UITableViewDataSource, UITableViewDelegate, UITabBarDelegate, UITextFieldDelegate {
    ...
    func textField(textField: UITextField, shouldChangeCharactersInRange range: NSRange, replacementString string: String) -> Bool {
        ...
        if(type == ""){
            ...
            set = NSCharacterSet(charactersInString: "ABCDEFGHIJKLMONPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789 ").invertedSet
        }else if(type == "number"){
            set = NSCharacterSet(charactersInString: "0123456789").invertedSet
        }else if(type == "float"){
            set = NSCharacterSet(charactersInString: ".0123456789").invertedSet
        }
