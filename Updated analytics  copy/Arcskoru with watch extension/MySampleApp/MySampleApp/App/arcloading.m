...
- (void)setupLayers{
    ...
    validatingtext.string          = @"Logging on...";
    validatingtext.font            = (__bridge CFTypeRef)@"OpenSans-Light";
    ...
    CALayer * xcv = [CALayer layer];
    [self.layer addSublayer:xcv];
    xcv.contents = (id)[UIImage imageNamed:@"xcv"].CGImage;
    self.layers[@"xcv"] = xcv;    
	[self setupLayerFrames];
}
...
- (void)setupLayerFrames{
    ...
    validatingtext.frame         = CGRectMake(0.19232 * CGRectGetWidth(validatingtext.superlayer.bounds), 0.89 * CGRectGetHeight(validatingtext.superlayer.bounds), 0.63536 * CGRectGetWidth(validatingtext.superlayer.bounds), 0.08116 * CGRectGetHeight(validatingtext.superlayer.bounds));
