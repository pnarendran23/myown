...
@IBDesignable class detailedgraph: UIView {
    ...
    override func drawRect(rect: CGRect) {
        if(NSUserDefaults.standardUserDefaults().objectForKey("ptsdata") != nil){
            graphPoints = NSKeyedUnarchiver.unarchiveObjectWithData(NSUserDefaults.standardUserDefaults().objectForKey("ptsdata") as! NSData) as! [Int]
        }
