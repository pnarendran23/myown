        ...
        DispatchQueue.main.async(execute: {
            ...
            if(self.currenttitle == "Name"){
                ...
                if(s > 0 && s <= 168){
                    ...
                    self.maketoast("Please enter a value less than 168", type: "error")
                }
                }else{
                self.maketoast("Please enter a value less than 168", type: "error")
            }
            ...
            let s = myInt as! Int
                if(s > 0 && s <= 20499999){
                    ...
                    self.maketoast("Please enter a value less than 20499999", type: "error")
                }
            }else{
                self.maketoast("Please enter a value less than 20499999", type: "error")
            }
                ...
                if(s > 0 && s <= 1000000000){
                    ...
                    self.maketoast("Please enter a value less than 1000000000", type: "error")
                }
                }else{
                    self.maketoast("Please enter a value less than 1000000000", type: "error")
                }
                ...
                if let myInt = Int(self.name){
                    let s = myInt as! Int
                if(s > 0 && s <= 1000000000){
                    self.data_dict["noOfFloors"] = Int(self.name)
                    self.navigationController?.popViewController(animated: true)
                }else if (s == 0){
                    self.maketoast("Please enter value greater than 0", type: "error")
                }else{
