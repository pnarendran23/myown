...
class addnewproject: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        //titlearr = NSArray()
        contentarray = ["name","unitType","spaceType","street","city","state","country","confidential","ownerType","organization","owner_email","PrevCertProdId","ldp_old","OtherCertProg","IsResidential","noOfResUnits","AffiliatedHigherEduIns","affiliatedWithLeedLab","year_constructed","noOfFloors","intentToPrecertify","gross_area","targetCertDate","operating_hours","occupancy"]
        
        reasondict = ["name":"Name","unitType":"Unit type","spaceType":"Space type","street":"Address","city":"City","state":"State","country":"Country","confidential":"Project is private","ownerType": "Owner type","organization":"Owner organization","owner_email":"Owner email","PrevCertProdId":"Previous LEED ID","ldp_old":"Previously LEED ertified","OtherCertProg":"Other certifications prusued","IsResidential":"Residential units","noOfResUnits":"Number of residential units","AffiliatedHigherEduIns":"Affiliated with higher education insititute","affiliatedWithLeedLab":"Affiliated with LEED lab","year_constructed":"Year contructed","noOfFloors":"Number of floors","intentToPrecertify":"Intented to Precertify","gross_area": "Gross floor area","targetCertDate":"Target certification date","operating_hours":"Operating hours","occupancy":"Occupancy"]
