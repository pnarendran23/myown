...
- (NSUInteger)supportedInterfaceOrientations
{
    ...
    if ([self.visibleViewController isMemberOfClass:[buttonarray class]] || [self.visibleViewController isMemberOfClass:[addsurvey class]] || [self.visibleViewController isMemberOfClass:[smiley class]] || [[self.visibleViewController restorationIdentifier] isEqualToString:@"plaque"]) {
