...
class overallplaque: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        performance_data = NSMutableDictionary.init(dictionary: NSKeyedUnarchiver.unarchiveObject(with: UserDefaults.standard.object(forKey: "performance_data") as! Data) as! NSMutableDictionary)
        }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if(indexPath.section == 0){
            ...
            if((performance_data["scores"] as? NSDictionary)?["energy"] == nil || (performance_data["scores"] as? NSDictionary)?["energy"] is NSNull){
                ...
                cell.percentagelbl.text = String(format: "%d",(performance_data["scores"] as? NSDictionary)?["energy"] as! Int)
                cell.contextlbl.text = "\(cell.percentagelbl.text! )% of Energy score (Out of 100)"
            }
            ...
            cell.vv.strokecolor = strokecolor
            if((performance_data["scores"] as? NSDictionary)?["water"] == nil || (performance_data["scores"] as? NSDictionary)?["water"] is NSNull){
                cell.vv.strokevalue = 0.0
                cell.percentagelbl.text = "0"
                ...
                cell.percentagelbl.text = String(format: "%d",(performance_data["scores"] as? NSDictionary)?["water"] as! Int)
                cell.contextlbl.text = "\(cell.percentagelbl.text! )% of Water score (Out of 100)"
            }
            ...
            cell.vv.strokecolor = strokecolor
            if((performance_data["scores"] as? NSDictionary)?["waste"] == nil || (performance_data["scores"] as? NSDictionary)?["waste"] is NSNull){
                cell.vv.strokevalue = 0.0
                cell.percentagelbl.text = "0"
                cell.contextlbl.text = "\(cell.percentagelbl.text! )% of Waste score (Out of 100)"
            }else{
                cell.percentagelbl.text = String(format: "%d",(performance_data["scores"] as? NSDictionary)?["waste"] as! Int)
                cell.contextlbl.text = "\(cell.percentagelbl.text! )% of Waste score (Out of 100)"
            ...
            cell.vv.strokecolor = strokecolor
            if((performance_data["scores"] as? NSDictionary)?["transport"] == nil || (performance_data["scores"] as? NSDictionary)?["transport"] is NSNull){
                cell.vv.strokevalue = 0.0
                cell.percentagelbl.text = "0"
                ...
                cell.percentagelbl.text = String(format: "%d",(performance_data["scores"] as? NSDictionary)?["transport"] as! Int)
                cell.contextlbl.text = "\(cell.percentagelbl.text! )% of Transportation score (Out of 100)"
            }
            ...
            if(indexPath.row == 0){
                cell.vv.strokecolor = strokecolor
                if((performance_data["scores"] as? NSDictionary)?["human_experience"] == nil || (performance_data["scores"] as? NSDictionary)?["human_experience"] is NSNull){
                    cell.vv.strokevalue = 0.0
                    cell.percentagelbl.text = "0"
                    ...
                    cell.percentagelbl.text = String(format: "%d",(performance_data["scores"] as? NSDictionary)?["human_experience"] as! Int)
                    cell.contextlbl.text = "\(cell.percentagelbl.text! )% of Human experience score (Out of 100)"
                }
            }
