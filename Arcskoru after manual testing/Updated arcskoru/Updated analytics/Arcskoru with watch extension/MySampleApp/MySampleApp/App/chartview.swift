...
class chartview: UIView {
    ...
    override init(frame: CGRect) {
        ...
        setupProperties()
        data2 = UserDefaults.standard.object(forKey: "data2") as! [Int]
        data = UserDefaults.standard.object(forKey: "data") as! [Int]
        if(data2.count==0){
    ...
    func setupLayers(){
        ...
        back.fillColor   = nil
        back.strokeColor = UIColor.lightGray.cgColor
        back.lineWidth   = 10
        layers["back"] = back
        ...
        front.fillColor   = nil
        front.strokeColor = UIColor(red:0.555, green: 0.806, blue:0.539, alpha:1).cgColor
        front.lineWidth   = 10
        front.strokeEnd   = 0
        layers["front"] = front
        ...
        back2.fillColor   = nil
        back2.strokeColor = UIColor.lightGray.cgColor
        back2.lineWidth   = 10
        back2.strokeEnd   = 0
        layers["back2"] = back2
        ...
        front2.strokeColor = UIColor(red:0.555, green: 0.806, blue:0.539, alpha:1).cgColor
        front2.lineWidth   = 10
        front2.strokeEnd   = 0
        ...
        back3.fillColor   = nil
        back3.strokeColor = UIColor.lightGray.cgColor
        back3.lineWidth   = 10
        back3.strokeEnd   = 0
        layers["back3"] = back3
        ...
        front3.strokeColor = UIColor(red:0.555, green: 0.806, blue:0.539, alpha:1).cgColor
        front3.lineWidth   = 10
        front3.strokeEnd   = 0
        ...
        back4.fillColor   = nil
        back4.strokeColor = UIColor.lightGray.cgColor
        back4.lineWidth   = 10
        back4.strokeEnd   = 0
        layers["back4"] = back4
        ...
        front4.strokeColor = UIColor(red:0.555, green: 0.806, blue:0.539, alpha:1).cgColor
        front4.lineWidth   = 10
        front4.strokeEnd   = 0
        ...
        back5.fillColor   = nil
        back5.strokeColor = UIColor.lightGray.cgColor
        back5.lineWidth   = 10
        back5.strokeEnd   = 0
        layers["back5"] = back5
        ...
        front5.strokeColor = UIColor(red:0.555, green: 0.806, blue:0.539, alpha:1).cgColor
        front5.lineWidth   = 10
        front5.strokeEnd   = 0
        ...
        back6.fillColor   = nil
        back6.strokeColor = UIColor.lightGray.cgColor
        back6.lineWidth   = 10
        back6.strokeEnd   = 0
        layers["back6"] = back6
        ...
        front6.strokeColor = UIColor(red:0.555, green: 0.806, blue:0.539, alpha:1).cgColor
        front6.lineWidth   = 10
        front6.strokeEnd   = 0
        ...
        back7.fillColor   = nil
        back7.strokeColor = UIColor.lightGray.cgColor
        back7.lineWidth   = 10
        back7.strokeEnd   = 0
        layers["back7"] = back7
        ...
        front7.strokeColor = UIColor(red:0.555, green: 0.806, blue:0.539, alpha:1).cgColor
        front7.lineWidth   = 10
        front7.strokeEnd   = 0
        ...
        back8.fillColor   = nil
        back8.strokeColor = UIColor.lightGray.cgColor
        back8.lineWidth   = 10
        back8.strokeEnd   = 0
        layers["back8"] = back8
        ...
        front8.strokeColor = UIColor(red:0.555, green: 0.806, blue:0.539, alpha:1).cgColor
        front8.lineWidth   = 10
        front8.strokeEnd   = 0
        ...
        back9.fillColor   = nil
        back9.strokeColor = UIColor.lightGray.cgColor
        back9.lineWidth   = 10
        back9.strokeEnd   = 0
        layers["back9"] = back9
        ...
        front9.strokeColor = UIColor(red:0.555, green: 0.806, blue:0.539, alpha:1).cgColor
        front9.lineWidth   = 10
        front9.strokeEnd   = 0
        ...
        back10.strokeColor = UIColor.lightGray.cgColor
        back10.lineWidth   = 10
        back10.strokeEnd   = 0
        ...
        front10.strokeColor = UIColor(red:0.555, green: 0.806, blue:0.539, alpha:1).cgColor
        ...
        back11.strokeColor = UIColor.lightGray.cgColor
        back11.lineWidth   = 10
        back11.strokeEnd   = 0
        ...
        front11.strokeColor = UIColor(red:0.555, green: 0.806, blue:0.539, alpha:1).cgColor
        ...
        back12.strokeColor = UIColor.lightGray.cgColor
        back12.lineWidth   = 10
        back12.strokeEnd   = 0
        ...
        front12.strokeColor = UIColor(red:0.555, green: 0.806, blue:0.539, alpha:1).cgColor
        ...
        back13.strokeColor = UIColor.lightGray.cgColor
        back13.lineWidth   = 10
        back13.strokeEnd   = 0
        ...
        front13.strokeColor = UIColor(red:0.555, green: 0.806, blue:0.539, alpha:1).cgColor
        ...
        back14.strokeColor = UIColor.lightGray.cgColor
        back14.lineWidth   = 10
        back14.strokeEnd   = 0
        ...
        front14.strokeColor = UIColor(red:0.555, green: 0.806, blue:0.539, alpha:1).cgColor
        ...
        back15.strokeColor = UIColor.lightGray.cgColor
        back15.lineWidth   = 10
        back15.strokeEnd   = 0
        ...
        front15.strokeColor = UIColor(red:0.555, green: 0.806, blue:0.539, alpha:1).cgColor
        ...
        text.fontSize        = 0.01 * self.frame.size.width
        ...
        text2.fontSize        = 0.01 * self.frame.size.width
        ...
        text4.fontSize        = 0.01 * self.frame.size.width
        ...
        text5.fontSize        = 0.01 * self.frame.size.width
        ...
        text6.fontSize        = 0.01 * self.frame.size.width
        ...
        text7.fontSize        = 0.01 * self.frame.size.width
        ...
        text8.fontSize        = 0.01 * self.frame.size.width
        ...
        text9.fontSize        = 0.01 * self.frame.size.width
        ...
        text10.fontSize        = 0.01 * self.frame.size.width
        ...
        durationtext.fontSize        = 0.01 * self.frame.size.width
        ...
        if(text6.string as! String == "6\n" ){
            if((data2.count>0 || data.count>0)&&(maxvalue>0)){
                ...
                text.string = String(format:"%d",Int(text10.string as! String)! - Int(text9.string as! String)!)
            }
        }
    ...
    func setupLayerFrames(){
        ...
        if let text : CATextLayer = layers["text"] as? CATextLayer{
            text.frame = CGRect(x: 0.11077 * text.superlayer!.bounds.width, y: 0.75833 * text.superlayer!.bounds.height, width: 0.05063 * text.superlayer!.bounds.width, height: 0.03833 * text.superlayer!.bounds.height)
            text.fontSize        = 0.014 * self.frame.size.width
        }
        
        if let text2 : CATextLayer = layers["text2"] as? CATextLayer{
            text2.frame = CGRect(x: 0.11077 * text2.superlayer!.bounds.width, y: 0.685 * text2.superlayer!.bounds.height, width: 0.05063 * text2.superlayer!.bounds.width, height: 0.03833 * text2.superlayer!.bounds.height)
            text2.fontSize        = 0.014 * self.frame.size.width
        }
        
        if let text3 : CATextLayer = layers["text3"] as? CATextLayer{
            text3.frame = CGRect(x: 0.11077 * text3.superlayer!.bounds.width, y: 0.61167 * text3.superlayer!.bounds.height, width: 0.05063 * text3.superlayer!.bounds.width, height: 0.03833 * text3.superlayer!.bounds.height)
            text3.fontSize        = 0.014 * self.frame.size.width
        }
        
        if let text4 : CATextLayer = layers["text4"] as? CATextLayer{
            text4.frame = CGRect(x: 0.11077 * text4.superlayer!.bounds.width, y: 0.53833 * text4.superlayer!.bounds.height, width: 0.05063 * text4.superlayer!.bounds.width, height: 0.03833 * text4.superlayer!.bounds.height)
            text4.fontSize        = 0.014 * self.frame.size.width
        }
        
        if let text5 : CATextLayer = layers["text5"] as? CATextLayer{
            text5.frame = CGRect(x: 0.11077 * text5.superlayer!.bounds.width, y: 0.465 * text5.superlayer!.bounds.height, width: 0.05063 * text5.superlayer!.bounds.width, height: 0.03833 * text5.superlayer!.bounds.height)
            text5.fontSize        = 0.014 * self.frame.size.width
        }
        
        if let text6 : CATextLayer = layers["text6"] as? CATextLayer{
            text6.frame = CGRect(x: 0.11077 * text6.superlayer!.bounds.width, y: 0.39167 * text6.superlayer!.bounds.height, width: 0.05063 * text6.superlayer!.bounds.width, height: 0.03833 * text6.superlayer!.bounds.height)
            text6.fontSize        = 0.014 * self.frame.size.width
        }
        
        if let text7 : CATextLayer = layers["text7"] as? CATextLayer{
            text7.frame = CGRect(x: 0.11077 * text7.superlayer!.bounds.width, y: 0.31833 * text7.superlayer!.bounds.height, width: 0.05063 * text7.superlayer!.bounds.width, height: 0.03833 * text7.superlayer!.bounds.height)
            text7.fontSize        = 0.014 * self.frame.size.width
        }
        
        if let text8 : CATextLayer = layers["text8"] as? CATextLayer{
            text8.frame = CGRect(x: 0.11077 * text8.superlayer!.bounds.width, y: 0.245 * text8.superlayer!.bounds.height, width: 0.05063 * text8.superlayer!.bounds.width, height: 0.03833 * text8.superlayer!.bounds.height)
            text8.fontSize        = 0.014 * self.frame.size.width
        }
        
        if let text9 : CATextLayer = layers["text9"] as? CATextLayer{
            text9.frame = CGRect(x: 0.11077 * text9.superlayer!.bounds.width, y: 0.17167 * text9.superlayer!.bounds.height, width: 0.05063 * text9.superlayer!.bounds.width, height: 0.03833 * text9.superlayer!.bounds.height)
            text9.fontSize        = 0.014 * self.frame.size.width
        }
        
        if let text10 : CATextLayer = layers["text10"] as? CATextLayer{
            text10.frame = CGRect(x: 0.11077 * text10.superlayer!.bounds.width, y: 0.09833 * text10.superlayer!.bounds.height, width: 0.05063 * text10.superlayer!.bounds.width, height: 0.03833 * text10.superlayer!.bounds.height)
            text10.fontSize        = 0.014 * self.frame.size.width
            
        }
        
        if let durationtext : CATextLayer = layers["durationtext"] as? CATextLayer{
            durationtext.frame = CGRect(x: 0.1601 * durationtext.superlayer!.bounds.width, y: 0.85312 * durationtext.superlayer!.bounds.height, width: 0.7426 * durationtext.superlayer!.bounds.width, height: 0.04 * durationtext.superlayer!.bounds.height)
            durationtext.fontSize        = 0.019 * self.frame.size.width
        }
    ...
    func addBarchartAnimation(){
        ...
        if(data2.count>=2){
            ...
            if(data.count == 2 && data2.count == 2){
                if let bar14 : CALayer = layers["bar14"] as? CALayer{
                    bar14.frame.origin.x = self.frame.size.width - (-0.21 * self.frame.size.width)
                    if let bar13 : CALayer = layers["bar13"] as? CALayer{
                        bar13.frame.origin.x = (bar14.frame.origin.x) - (0.05 * self.frame.size.width)
                        
                        if let bar12 : CALayer = layers["bar12"] as? CALayer{
                            bar12.frame.origin.x = bar13.frame.origin.x - (0.05 * self.frame.size.width)
                            
                            if let bar11 : CALayer = layers["bar11"] as? CALayer{
                                bar11.frame.origin.x = bar12.frame.origin.x - (0.05 * self.frame.size.width)
                                
                                if let bar10 : CALayer = layers["bar10"] as? CALayer{
                                    bar10.frame.origin.x = bar11.frame.origin.x - (0.05 * self.frame.size.width)
                                    
                                    if let bar9 : CALayer = layers["bar9"] as? CALayer{
                                        bar9.frame.origin.x = bar10.frame.origin.x - (0.05 * self.frame.size.width)
                                        
                                        if let bar8 : CALayer = layers["bar8"] as? CALayer{
                                            bar8.frame.origin.x = bar9.frame.origin.x - (0.05 * self.frame.size.width)
                                            
                                            if let bar7 : CALayer = layers["bar7"] as? CALayer{
                                                bar7.frame.origin.x = bar8.frame.origin.x - (0.05 * self.frame.size.width)
                                                
                                                if let bar6 : CALayer = layers["bar6"] as? CALayer{
                                                    bar6.frame.origin.x = bar7.frame.origin.x - (0.05 * self.frame.size.width)
                                                    
                                                    if let bar5 : CALayer = layers["bar5"] as? CALayer{
                                                        bar5.frame.origin.x = bar6.frame.origin.x - (0.05 * self.frame.size.width)
                                                        
                                                        if let bar4 : CALayer = layers["bar4"] as? CALayer{
                                                            bar4.frame.origin.x = bar5.frame.origin.x - (0.05 * self.frame.size.width)
                                                            
                                                            if let bar3 : CALayer = layers["bar3"] as? CALayer{
                                                                bar3.frame.origin.x = bar4.frame.origin.x - (0.05 * self.frame.size.width)
                                                                
                                                                if let bar2 : CALayer = layers["bar2"] as? CALayer{
                                                                    bar2.frame.origin.x = bar3.frame.origin.x - (0.05 * self.frame.size.width)
                                                                    
                                                                    if let bar1 : CALayer = layers["bar"] as? CALayer{
                                                                        bar1.frame.origin.x = bar2.frame.origin.x - (0.05 * self.frame.size.width)
                                                                    }}}}}}}}}}}}}}
            }
        ...
        if(data2.count>=3){
            ...
            if(data.count == 3 && data2.count == 3){
                if let bar14 : CALayer = layers["bar14"] as? CALayer{
                    bar14.frame.origin.x = self.frame.size.width - (-0.18 * self.frame.size.width)
                    if let bar13 : CALayer = layers["bar13"] as? CALayer{
                        bar13.frame.origin.x = (bar14.frame.origin.x) - (0.05 * self.frame.size.width)
        ...
        if(data2.count>=4){
            ...
            if(data.count == 4 && data2.count == 4){
                if let bar14 : CALayer = layers["bar14"] as? CALayer{
                    bar14.frame.origin.x = self.frame.size.width - (-0.15 * self.frame.size.width)
                    if let bar13 : CALayer = layers["bar13"] as? CALayer{
                        bar13.frame.origin.x = (bar14.frame.origin.x) - (0.05 * self.frame.size.width)
        ...
        if(data2.count>=5){
            ...
            if(data.count == 5 && data2.count == 5){
                if let bar14 : CALayer = layers["bar14"] as? CALayer{
                    bar14.frame.origin.x = self.frame.size.width - (-0.12 * self.frame.size.width)
                    if let bar13 : CALayer = layers["bar13"] as? CALayer{
                        bar13.frame.origin.x = (bar14.frame.origin.x) - (0.05 * self.frame.size.width)
        ...
        if(data2.count>=6){
            ...
            if(data.count == 6 && data2.count == 6){
                if let bar14 : CALayer = layers["bar14"] as? CALayer{
                    bar14.frame.origin.x = self.frame.size.width - (-0.09 * self.frame.size.width)
                    if let bar13 : CALayer = layers["bar13"] as? CALayer{
                        bar13.frame.origin.x = (bar14.frame.origin.x) - (0.05 * self.frame.size.width)
        ...
        if(data2.count>=7){
            ...
            if(data.count == 7 && data2.count == 7){
                if let bar14 : CALayer = layers["bar14"] as? CALayer{
                    bar14.frame.origin.x = self.frame.size.width - (-0.06 * self.frame.size.width)
                    if let bar13 : CALayer = layers["bar13"] as? CALayer{
                        bar13.frame.origin.x = (bar14.frame.origin.x) - (0.05 * self.frame.size.width)
        ...
        if(data2.count>=8){
            ...
            if(data.count == 8 && data2.count == 8){
                if let bar14 : CALayer = layers["bar14"] as? CALayer{
                    bar14.frame.origin.x = self.frame.size.width - (-0.03 * self.frame.size.width)
                    if let bar13 : CALayer = layers["bar13"] as? CALayer{
                        bar13.frame.origin.x = (bar14.frame.origin.x) - (0.05 * self.frame.size.width)
        ...
        if(data2.count>=9){
            ...
            var f3 = f1/f2
            ////print("f3 is",f3)
            if(data.count == 9 && data2.count == 9){
                if let bar14 : CALayer = layers["bar14"] as? CALayer{
                    bar14.frame.origin.x = self.frame.size.width - (0.00 * self.frame.size.width)
                    if let bar13 : CALayer = layers["bar13"] as? CALayer{
                        bar13.frame.origin.x = (bar14.frame.origin.x) - (0.05 * self.frame.size.width)
        ...
        if(data2.count>=10){
            ...
            var f3 = f1/f2
            ////print("f3 is",f3)
            if(data.count == 10 && data2.count == 10){
                if let bar14 : CALayer = layers["bar14"] as? CALayer{
                    bar14.frame.origin.x = self.frame.size.width - (0.03 * self.frame.size.width)
                    if let bar13 : CALayer = layers["bar13"] as? CALayer{
                        bar13.frame.origin.x = (bar14.frame.origin.x) - (0.05 * self.frame.size.width)
        ...
        if(data2.count>=11){
            ...
            var f3 = f1/f2
            ////print("f3 is",f3)
            if(data.count == 11 && data2.count == 11){
                if let bar14 : CALayer = layers["bar14"] as? CALayer{
                    bar14.frame.origin.x = self.frame.size.width - (0.06 * self.frame.size.width)
                    if let bar13 : CALayer = layers["bar13"] as? CALayer{
                        bar13.frame.origin.x = (bar14.frame.origin.x) - (0.05 * self.frame.size.width)
        ...
        if(data2.count>=12){
            ...
            var f3 = f1/f2
            ////print("f3 is",f3)
            if(data.count == 12 && data2.count == 12){
                if let bar14 : CALayer = layers["bar14"] as? CALayer{
                    bar14.frame.origin.x = self.frame.size.width - (0.09 * self.frame.size.width)
                    if let bar13 : CALayer = layers["bar13"] as? CALayer{
                        bar13.frame.origin.x = (bar14.frame.origin.x) - (0.05 * self.frame.size.width)
        ...
        if(data2.count>=13){
            ...
            var f3 = f1/f2
            ////print("f3 is",f3)
            if(data.count == 13 && data2.count == 13){
                if let bar14 : CALayer = layers["bar14"] as? CALayer{
                    bar14.frame.origin.x = self.frame.size.width - (0.12 * self.frame.size.width)
                    if let bar13 : CALayer = layers["bar13"] as? CALayer{
                        bar13.frame.origin.x = (bar14.frame.origin.x) - (0.05 * self.frame.size.width)
        ...
        if(data2.count>=14){
            ...
            var f2 = Float(outofscore)
            var f3 = f1/f2
            if(data.count == 14 && data2.count == 14){
                if let bar14 : CALayer = layers["bar14"] as? CALayer{
                    bar14.frame.origin.x = self.frame.size.width - (0.15 * self.frame.size.width)
                    if let bar13 : CALayer = layers["bar13"] as? CALayer{
                        bar13.frame.origin.x = (bar14.frame.origin.x) - (0.05 * self.frame.size.width)
