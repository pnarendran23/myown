...
class co2: UIView {
    ...
    override init(frame: CGRect) {
        ...
        data = UserDefaults.standard.object(forKey: "co2") as! [Int]
        if(data2.count==0){
    ...
    func setupLayers(){
        ...
        if(UserDefaults.standard.object(forKey: "startdateforco2") != nil){
            let startdate = UserDefaults.standard.object(forKey: "startdateforco2") as! Date
            let enddate = UserDefaults.standard.object(forKey: "enddateforco2") as! Date
