...
//        setupProperties()
    ...
    func setupProperties(){
        ...
        if let context1 : CATextLayer = layers["context1"] as? CATextLayer{
            ...
            context1.fontSize = (0.25 * context1.superlayer!.bounds.height)/12
        ...
        if let middlelabel : CATextLayer = layers["middlelabel"] as? CATextLayer{
            ...
            middlelabel.fontSize = (0.25 * middlelabel.superlayer!.bounds.height)/12
        ...
        if let innerlabel : CATextLayer = layers["innerlabel"] as? CATextLayer{
            ...
            innerlabel.fontSize = (0.25 * innerlabel.superlayer!.bounds.height)/12
        ...
        if let outermaxscore : CATextLayer = layers["outermaxscore"] as? CATextLayer{
            ...
            outermaxscore.fontSize = (0.18 * outermaxscore.superlayer!.bounds.height)/10
        ...
        if let middlemaxscore : CATextLayer = layers["middlemaxscore"] as? CATextLayer{
            ...
            middlemaxscore.fontSize = (0.18 * middlemaxscore.superlayer!.bounds.height)/10
        ...
        if let innermaxscore : CATextLayer = layers["innermaxscore"] as? CATextLayer{
            ...
            innermaxscore.fontSize = (0.18 * innermaxscore.superlayer!.bounds.height)/10
        ...
        if let localavgscore : CATextLayer = layers["localavgscore"] as? CATextLayer{
            ...
            localavgscore.fontSize = (0.18 * localavgscore.superlayer!.bounds.height)/10
        ...
        if let globalavgscore : CATextLayer = layers["globalavgscore"] as? CATextLayer{
            ...
            globalavgscore.fontSize = (0.18 * globalavgscore.superlayer!.bounds.height)/10
