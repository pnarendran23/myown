...
class listgraph: UIView {
    ...
    func setupLayers(){
        ...
        text3.foregroundColor = UIColor.white.cgColor;
        layers["text3"] = text3
    ...
    func setupLayerFrames(){
        ...
        if let text : CATextLayer = layers["text"] as? CATextLayer{
            text.frame = CGRect(x: 0, y: 0.92119 * text.superlayer!.bounds.height,  width: text.superlayer!.bounds.width, height: 0.11881 * text.superlayer!.bounds.width)
        }
        ...
        if let ic_lomobile_navitem_energy : CALayer = layers["ic_lomobile_navitem_energy"] as? CALayer{
            ic_lomobile_navitem_energy.frame = CGRect(x: 0.04579 * ic_lomobile_navitem_energy.superlayer!.bounds.width, y: 0.7754 * ic_lomobile_navitem_energy.superlayer!.bounds.height, width: 0.07511 * ic_lomobile_navitem_energy.superlayer!.bounds.width, height: 0.08403 * ic_lomobile_navitem_energy.superlayer!.bounds.width)
        }
        
        if let ic_lomobile_navitem_water : CALayer = layers["ic_lomobile_navitem_water"] as? CALayer{
            ic_lomobile_navitem_water.frame = CGRect(x: 0.25856 * ic_lomobile_navitem_water.superlayer!.bounds.width, y: 0.7754 * ic_lomobile_navitem_water.superlayer!.bounds.height, width: 0.07511 * ic_lomobile_navitem_water.superlayer!.bounds.width, height: 0.08403 * ic_lomobile_navitem_water.superlayer!.bounds.width)
        }
        
        if let ic_lomobile_navitem_waste : CALayer = layers["ic_lomobile_navitem_waste"] as? CALayer{
            ic_lomobile_navitem_waste.frame = CGRect(x: 0.45745 * ic_lomobile_navitem_waste.superlayer!.bounds.width, y: 0.7754 * ic_lomobile_navitem_waste.superlayer!.bounds.height, width: 0.07511 * ic_lomobile_navitem_waste.superlayer!.bounds.width, height: 0.08403 * ic_lomobile_navitem_waste.superlayer!.bounds.width)
        }
        
        if let ic_lomobile_navitem_transport : CALayer = layers["ic_lomobile_navitem_transport"] as? CALayer{
            ic_lomobile_navitem_transport.frame = CGRect(x: 0.68409 * ic_lomobile_navitem_transport.superlayer!.bounds.width, y: 0.7754 * ic_lomobile_navitem_transport.superlayer!.bounds.height, width: 0.07511 * ic_lomobile_navitem_transport.superlayer!.bounds.width, height: 0.08403 * ic_lomobile_navitem_transport.superlayer!.bounds.width)
        }
        
        if let ic_lomobile_navitem_human : CALayer = layers["ic_lomobile_navitem_human"] as? CALayer{
            ic_lomobile_navitem_human.frame = CGRect(x: 0.88622 * ic_lomobile_navitem_human.superlayer!.bounds.width, y: 0.7754 * ic_lomobile_navitem_human.superlayer!.bounds.height, width: 0.07511 * ic_lomobile_navitem_human.superlayer!.bounds.width, height: 0.08403 * ic_lomobile_navitem_human.superlayer!.bounds.width)
        }
