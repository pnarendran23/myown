...
class voc: UIView {
    ...
    override init(frame: CGRect) {
        ...
        data = NSUserDefaults.standardUserDefaults().objectForKey("voc") as! [Int]
        if(data2.count==0){
    ...
    func setupLayers(){
        ...
        if(NSUserDefaults.standardUserDefaults().objectForKey("startdateforvoc") != nil){
            var startdate = NSUserDefaults.standardUserDefaults().objectForKey("startdateforvoc") as! NSDate
            var enddate = NSUserDefaults.standardUserDefaults().objectForKey("enddateforvoc") as! NSDate
