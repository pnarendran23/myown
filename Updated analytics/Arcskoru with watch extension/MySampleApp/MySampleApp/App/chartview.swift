...
class chartview: UIView {
    ...
    override init(frame: CGRect) {
        ...
        data = NSUserDefaults.standardUserDefaults().objectForKey("data") as! [Int]
        if(data2.count==0){
    ...
    func setupLayers(){
        ...
        maxvalue = [temp1,temp2].maxElement()!
        temp2 = data2.count
        temp1 = data.count
        ...
        back.fillColor   = nil
        back.strokeColor = UIColor.lightGrayColor().CGColor
        back.lineWidth   = 10
        layers["back"] = back
        ...
        back2.fillColor   = nil
        back2.strokeColor = UIColor.lightGrayColor().CGColor
        back2.lineWidth   = 10
        back2.strokeEnd   = 0
        layers["back2"] = back2
        ...
        back3.fillColor   = nil
        back3.strokeColor = UIColor.lightGrayColor().CGColor
        back3.lineWidth   = 10
        back3.strokeEnd   = 0
        layers["back3"] = back3
        ...
        back4.fillColor   = nil
        back4.strokeColor = UIColor.lightGrayColor().CGColor
        back4.lineWidth   = 10
        back4.strokeEnd   = 0
        layers["back4"] = back4
        ...
        back5.fillColor   = nil
        back5.strokeColor = UIColor.lightGrayColor().CGColor
        back5.lineWidth   = 10
        back5.strokeEnd   = 0
        layers["back5"] = back5
        ...
        back6.fillColor   = nil
        back6.strokeColor = UIColor.lightGrayColor().CGColor
        back6.lineWidth   = 10
        back6.strokeEnd   = 0
        layers["back6"] = back6
        ...
        back7.fillColor   = nil
        back7.strokeColor = UIColor.lightGrayColor().CGColor
        back7.lineWidth   = 10
        back7.strokeEnd   = 0
        layers["back7"] = back7
        ...
        back8.fillColor   = nil
        back8.strokeColor = UIColor.lightGrayColor().CGColor
        back8.lineWidth   = 10
        back8.strokeEnd   = 0
        layers["back8"] = back8
        ...
        back9.fillColor   = nil
        back9.strokeColor = UIColor.lightGrayColor().CGColor
        back9.lineWidth   = 10
        back9.strokeEnd   = 0
        layers["back9"] = back9
        ...
        back10.strokeColor = UIColor.lightGrayColor().CGColor
        back10.lineWidth   = 10
        back10.strokeEnd   = 0
        ...
        back11.strokeColor = UIColor.lightGrayColor().CGColor
        back11.lineWidth   = 10
        back11.strokeEnd   = 0
        ...
        back12.strokeColor = UIColor.lightGrayColor().CGColor
        back12.lineWidth   = 10
        back12.strokeEnd   = 0
        ...
        back13.strokeColor = UIColor.lightGrayColor().CGColor
        back13.lineWidth   = 10
        back13.strokeEnd   = 0
        ...
        back14.strokeColor = UIColor.lightGrayColor().CGColor
        back14.lineWidth   = 10
        back14.strokeEnd   = 0
        ...
        back15.strokeColor = UIColor.lightGrayColor().CGColor
        back15.lineWidth   = 10
        back15.strokeEnd   = 0
        ...
        if(NSUserDefaults.standardUserDefaults().objectForKey("startdate") != nil){
            var startdate = NSUserDefaults.standardUserDefaults().objectForKey("startdate") as! NSDate
            var enddate = NSUserDefaults.standardUserDefaults().objectForKey("enddate") as! NSDate
           var dateformatter = NSDateFormatter()
            dateformatter.dateFormat = "d MMM yyyy"
            var date = NSMutableString()
            date.appendString(dateformatter.stringFromDate(startdate))
            date.appendString(" to ")
            date.appendString(dateformatter.stringFromDate(enddate))
            //print("Formatted date", date)
        durationtext.string          = date
        }else if(NSUserDefaults.standardUserDefaults().objectForKey("transit") != nil){
            durationtext.string          = "\n"    
        }else{
        durationtext.string          = "\n"
        }
        durationtext.font            = "OpenSans"
