...
//             UIColor( red: 12/255, green: 133/255, blue: 145/255, alpha: 1)
//            UIColor(red: 0.5, green: 0.65, blue: 0.5, alpha: 0.95)
            leftViewBackgroundColor =  UIColor( red: 12/255, green: 133/255, blue: 145/255, alpha: 1)
            rootViewCoverColorForLeftView =  UIColor( red: 12/255, green: 133/255, blue: 145/255, alpha: 1)

        }

        // -----

        let greenCoverColor = UIColor( red: 12/255, green: 133/255, blue: 145/255, alpha: 1)
        let purpleCoverColor =  UIColor( red: 12/255, green: 133/255, blue: 145/255, alpha: 1)
...
//            rightViewPresentationStyle = .slideBelow
    ...
    override func leftViewWillLayoutSubviews(with size: CGSize) {
        ...
        if !isLeftViewStatusBarHidden {
            leftView?.frame = CGRect(x: 0.0, y: 0.0, width: size.width, height: size.height - 20.0)
        }
    }
