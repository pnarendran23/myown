...
var rowarr = [["Pre-requisites","Base scores","Data input","All actions"],["To me","To somebody","To None"],["Attempted","Under review"]]
    ...
    override func viewDidLoad() {
        ...
        if(assets["project_type"] as! String == "building" && assets["rating_system"] as! String != "LEED V4 O+M: EB WP"){
            rowarr = [["Data input"],["To me","To somebody","To None"],["Attempted","Under review"]]
