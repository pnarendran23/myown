...
NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(self.adjustwidth), name: UIDeviceOrientationDidChangeNotification, object: nil)
     ...
     navigationController?.navigationBar.barTintColor = UIColor.whiteColor()
        ...
        self.navigationController!.navigationBar.titleTextAttributes = [ NSFontAttributeName: UIFont(name: "OpenSans-Semibold", size: 13)!]
        if(self.toload == true){
    ...
    func getscores(leedid:Int, token:String){
        ...
        for index in 0...11 {
            ...
            let url = NSURL(string: "https://api.usgbc.org/dev/leed/assets/LEED:\(leedid)/scores/?at=\(datearr.objectAtIndex(index))&within=1")
    ...
    func getanalysis(leedid:Int,token:String){
        let url = NSURL(string: "https://api.usgbc.org/dev/leed/assets/LEED:\(leedid)/analysis/")
        let request = NSMutableURLRequest.init(URL: url!)
        request.HTTPMethod = "GET"
        request.addValue(credentials().subscription_key, forHTTPHeaderField:"Ocp-Apim-Subscription-Key" )
        request.addValue("application/json", forHTTPHeaderField:"Content-type" )
            ...
            if(dict[key] != nil){
                if(dict[key]!["info_json"] is NSNull){
                    ...
                    do {
                        ...
                        if let actionString = dict[key]!["info_json"]!![getkey] as? Int {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        if(indexPath.section == 0){
            ...
            tempostring.addAttribute(NSForegroundColorAttributeName, value: UIColor.whiteColor(), range: NSMakeRange(0, tempostring.length))
            tempostring.addAttribute(NSFontAttributeName, value: UIFont.init(name: "OpenSans-Bold", size: 14)! , range: NSMakeRange(0, tempostring.length))
            ...
            tempostring.addAttribute(NSForegroundColorAttributeName, value: UIColor.whiteColor(), range: NSMakeRange(0, tempostring.length))
            tempostring.addAttribute(NSFontAttributeName, value: UIFont.init(name: "OpenSans-Light", size: 12)! , range: NSMakeRange(0, tempostring.length))
            actualstring.appendAttributedString(tempostring.mutableCopy() as! NSAttributedString)
            tempostring.deleteCharactersInRange(NSMakeRange(0, tempostring.length))
            tempostring = NSMutableAttributedString(string:"\n")
            actualstring.appendAttributedString(tempostring.mutableCopy() as! NSAttributedString)
            ...
            cell.leedid.text = String(format: "%d",NSUserDefaults.standardUserDefaults().integerForKey("leed_id"))
            ...
            view.frame = cell.circularview.frame
            ...
            cell.highscore.text = String(format: "Highest score during reporting period:  %d", highduringreport)
            cell.lowscore.text = String(format: "Lowest score during reporting period:  %d", lessduringreport)
            cell.layoutSubviews()
            ...
            titles = NSMutableAttributedString(string: "AWARDED DATE : ")
            titles.addAttribute(NSForegroundColorAttributeName, value: UIColor.lightGrayColor(), range: NSMakeRange(0, titles.length))
            titles.addAttribute(NSFontAttributeName, value: UIFont.init(name: "OpenSans-Bold", size: 12)! , range: NSMakeRange(0, titles.length))
            ...
            titles.deleteCharactersInRange(NSMakeRange(0, titles.length))
            titles = NSMutableAttributedString(string: "OTHER CERTIFICATION AWARDED DATE : ")
            titles.addAttribute(NSForegroundColorAttributeName, value: UIColor.lightGrayColor(), range: NSMakeRange(0, titles.length))
            titles.addAttribute(NSFontAttributeName, value: UIFont.init(name: "OpenSans-Bold", size: 12)! , range: NSMakeRange(0, titles.length))
            titles.appendAttributedString(NSAttributedString.init(string: "Not available"))
    ...
    func initiall1text(value:Int, key:String) -> String{
        let roundedValue = 0.0
        return "If I reduce my emissions by 10%"
        let dict = self.analysisdict.mutableCopy() as! NSMutableDictionary
        ...
        if(dict[key] is NSNull){
            ...
            if(dict[key]!["info_json"] is NSNull){
                ...
                do {
                    ...
                    if let actionString = dict[key]!["info_json"]!![getkey] as? Int {
                        // action is not nil, is a String type, and is now stored in actionString
                        return String(format:"My new %@ score will be %d",dict[key]!["category"]!! as! String,dict[key]!["info_json"]!![getkey] as! Int)
                    }else{
                        return "Not available"
                    }
                }catch{
    ...
    func slider1changed(sender: UISlider){
        if(analysisdict.count > 0){
            ...
            if(self.view.viewWithTag(tag) != nil){
                var label1 = self.view.viewWithTag(tag) as! UILabel
                var label2 = self.view.viewWithTag(tag+1) as! UILabel
                ...
                if(sender.value == 0.0){
                    ...
                    var key = ""
                    var dict = self.analysisdict.mutableCopy() as! NSMutableDictionary
                    if(sender.tag-400 == 2){
                        key = "energy"
                    ...
                    if(dict[key] is NSNull){
                        ...
                        if(dict[key]!["info_json"] is NSNull){
                            ...
                            do {
                                ...
                                dict.setValue(temp, forKey: key)
                                //print(dict[key])
                                var getkey = "\(dict[key]!["category"]!! as! String) Plaque Score with 20% Lower Emissions"
                                if let actionString = dict[key]!["info_json"]!![getkey] as? Int {
                                    // action is not nil, is a String type, and is now stored in actionString
                                    label2.text = String(format:"My new %@ score will be %d",dict[key]!["category"]!! as! String,dict[key]!["info_json"]!![getkey] as! Int)
                                }else{
                    ...
                    if(dict[key] is NSNull){
                        ...
                        if(dict[key]!["info_json"] is NSNull){
                            ...
                            do {
                                ...
                                dict.setValue(temp, forKey: key)
                                //print(dict[key])
                                var getkey = "\(dict[key]!["category"]!! as! String) Plaque Score with 50% Lower Emissions"
                ...
                if(sender.tag == 403){
                    var label1 = self.view.viewWithTag(2001) as! UILabel
                    var label2 = self.view.viewWithTag(2002) as! UILabel
                ...
                if(sender.tag == 404){
                    var label1 = self.view.viewWithTag(3001) as! UILabel
                    var label2 = self.view.viewWithTag(3002) as! UILabel
                ...
                if(sender.tag == 405){
                    var label1 = self.view.viewWithTag(4001) as! UILabel
                    var label2 = self.view.viewWithTag(4002) as! UILabel
                ...
                if(sender.tag == 406){
                    var label1 = self.view.viewWithTag(5001) as! UILabel
                    var label2 = self.view.viewWithTag(5002) as! UILabel
            ...
            if(tempvalues.count > 0){
                if(self.view.viewWithTag(tag) != nil){
                    ...
                    if(Int(Int(roundedValue)/Int(step1)) < sortedkeys.count){
                        ...
                        var str = String(format: "%d",sortedkeys[Int(index)])
                        //print(str)
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if(segue.identifier == "gotographs"){
            var split = segue.destinationViewController as! UISplitViewController
            ...
            var vc = segue.destinationViewController as! overalldetails
            vc.datearr = datearr
            ...
            NSUserDefaults.standardUserDefaults().setObject(NSKeyedArchiver.archivedDataWithRootObject(reportedscores), forKey: "reportedscoresarr")
            NSUserDefaults.standardUserDefaults().setObject(NSKeyedArchiver.archivedDataWithRootObject(analysisdict), forKey: "analysisdict")
            var vc = segue.destinationViewController as! analysisgraph
            if(sel == 50){
                vc.type = "energy"
                var dict = self.analysisdict as! NSDictionary
                ...
                vc.type = "transport"
                vc.startcolor = UIColor.init(red: 0.572, green: 0.556, blue: 0.505, alpha: 1)
                vc.endcolor = UIColor.init(red: 0.876, green: 0.858, blue: 0.803, alpha: 1)
                ...
                vc.startcolor = UIColor.init(red: 0.92, green: 0.609, blue: 0.236, alpha: 1)
                vc.endcolor = UIColor.init(red: 0.901, green: 0.867, blue: 0.603, alpha: 1)
                vc.str1 = "0.000"
                vc.str2 = "0.000"
            }
            vc.reportedscores = reportedscores
