...
class co2: UIView {
    ...
    func setupLayerFrames(){
        ...
        if let title : CATextLayer = layers["title"] as? CATextLayer{
            title.frame = CGRectMake(0.0377 * title.superlayer!.bounds.width, 0.03708 * title.superlayer!.bounds.height, 0.12667 * title.superlayer!.bounds.width, 0.03861 * title.superlayer!.bounds.height)
        }
