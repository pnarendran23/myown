...
class circularprogress: UIView {
    ...
    func setupLayers(){
        ...
        currentscore.font            = "OpenSans-Bold"
        currentscore.fontSize        = 17
        currentscore.alignmentMode   = kCAAlignmentCenter;
        currentscore.foregroundColor = UIColor.whiteColor().CGColor;
        ...
        outof.foregroundColor = UIColor.whiteColor().CGColor;
        layers["outof"] = outof
        ...
        outercircle.strokeColor = UIColor(red:0.936, green: 0.957, blue:0.957, alpha:1).CGColor
        ...
        progresscircle.strokeColor   = UIColor(red:0.122, green: 0.781, blue:0.809, alpha:1).CGColor
    ...
    func setupLayerFrames(){
        ...
        if let currentscore : CATextLayer = layers["currentscore"] as? CATextLayer{
            currentscore.frame = CGRectMake(0.37626 * currentscore.superlayer!.bounds.width, 0.39153 * currentscore.superlayer!.bounds.height, 0.28749 * currentscore.superlayer!.bounds.width, 0.29115 * currentscore.superlayer!.bounds.height)
        }
