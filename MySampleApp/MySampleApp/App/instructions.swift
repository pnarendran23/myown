...
class instructions: UIViewController, UIPageViewControllerDataSource {
...
var imgarray = [UIImage(named: ("list of buildings")),UIImage(named: ("plaque")),UIImage(named: ("analytics")),UIImage(named: ("calculate")),UIImage(named: ("organize")), UIImage(named: ("notifications"))]
    ...
    override func viewDidLoad() {
        ...
        pageviewcontroller.view.frame.size.height = self.view.frame.size.height - (0.23*self.view.frame.size.width)
