...
class detailedanimview: UIView {
    ...
    func setupLayerFrames(){
        ...
        if let text : CATextLayer = layers["text"] as? CATextLayer{
            text.frame = CGRectMake(0, 0.94119 * text.superlayer!.bounds.height,  text.superlayer!.bounds.width, 0.11881 * text.superlayer!.bounds.width)
        }
        ...
        if let ic_lomobile_navitem_energy : CALayer = layers["ic_lomobile_navitem_energy"] as? CALayer{
            ic_lomobile_navitem_energy.frame = CGRectMake(0.04579 * ic_lomobile_navitem_energy.superlayer!.bounds.width, 0.7754 * ic_lomobile_navitem_energy.superlayer!.bounds.height, 0.08511 * ic_lomobile_navitem_energy.superlayer!.bounds.width, 0.09403 * ic_lomobile_navitem_energy.superlayer!.bounds.width)
        }
        
        if let ic_lomobile_navitem_water : CALayer = layers["ic_lomobile_navitem_water"] as? CALayer{
            ic_lomobile_navitem_water.frame = CGRectMake(0.25856 * ic_lomobile_navitem_water.superlayer!.bounds.width, 0.7754 * ic_lomobile_navitem_water.superlayer!.bounds.height, 0.08511 * ic_lomobile_navitem_water.superlayer!.bounds.width, 0.09403 * ic_lomobile_navitem_water.superlayer!.bounds.width)
        }
        
        if let ic_lomobile_navitem_waste : CALayer = layers["ic_lomobile_navitem_waste"] as? CALayer{
            ic_lomobile_navitem_waste.frame = CGRectMake(0.45745 * ic_lomobile_navitem_waste.superlayer!.bounds.width, 0.7754 * ic_lomobile_navitem_waste.superlayer!.bounds.height, 0.08511 * ic_lomobile_navitem_waste.superlayer!.bounds.width, 0.09403 * ic_lomobile_navitem_waste.superlayer!.bounds.width)
        }
        
        if let ic_lomobile_navitem_transport : CALayer = layers["ic_lomobile_navitem_transport"] as? CALayer{
            ic_lomobile_navitem_transport.frame = CGRectMake(0.68409 * ic_lomobile_navitem_transport.superlayer!.bounds.width, 0.7754 * ic_lomobile_navitem_transport.superlayer!.bounds.height, 0.08511 * ic_lomobile_navitem_transport.superlayer!.bounds.width, 0.09403 * ic_lomobile_navitem_transport.superlayer!.bounds.width)
        }
        
        if let ic_lomobile_navitem_human : CALayer = layers["ic_lomobile_navitem_human"] as? CALayer{
            ic_lomobile_navitem_human.frame = CGRectMake(0.88622 * ic_lomobile_navitem_human.superlayer!.bounds.width, 0.7754 * ic_lomobile_navitem_human.superlayer!.bounds.height, 0.08511 * ic_lomobile_navitem_human.superlayer!.bounds.width, 0.09403 * ic_lomobile_navitem_human.superlayer!.bounds.width)
        }
