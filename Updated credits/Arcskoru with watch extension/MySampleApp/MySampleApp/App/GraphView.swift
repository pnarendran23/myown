...
@IBDesignable class GraphView: UIView {
  ...
  //1 - the properties for the gradient
    ...
    @IBInspectable var endColorr: UIColor = UIColor.init(red: 237/255, green: 175/255, blue: 43/255, alpha: 1)
    @IBInspectable var startColorr: UIColor = UIColor.init(colorLiteralRed: 248/255, green: 228/255, blue: 214/255, alpha: 1)
    ...
    override func drawRect(rect: CGRect) {
        ...
        let color = UIColor.blackColor()//UIColor(white: 1.0, alpha: 0.3)
        color.setStroke()
        ...
        //5 - create the gradient
        let gradientt = CGGradientCreateWithColors(colorSpaces, colorr as CFArray, colorLocationss)
        
        CGContextDrawLinearGradient(context!, gradientt!, startPoint, endPoint, CGGradientDrawingOptions(rawValue: UInt32(0)))
