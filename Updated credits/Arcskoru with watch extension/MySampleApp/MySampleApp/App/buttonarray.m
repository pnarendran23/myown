...
-(void)viewWillAppear:(BOOL)animated{
    ...
    self.gtitle.text=@"Select the modes of transport that you used on this route";
    self.gtitle.numberOfLines=2;
    self.gtitle.font=[UIFont fontWithName:@"Gotham" size:16];
...
- (void)viewDidLoad {
    ...
    for (int j=0; j<4; j++) {
        ...
        if(j==0){
            title=@"Car";
            [Button setImage:[UIImage imageNamed:@"ic_lomobile_transit_car_small.png"]
        ...
        if ( UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad ){
            ...
            if(width==320 && height==568){
                ...
                Button.titleLabel.font=[UIFont fontWithName:@"Gotham" size:12];
        ...
        if(j<=2){
            ...
            if ( UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad ){
                Button1.titleLabel.font=[UIFont fontWithName:@"Gotham" size:19];
                [Button1 setTitleEdgeInsets:UIEdgeInsetsMake(0.0, 40, 0.0, -0.03125*width)];
            }
            else{
                Button1.titleLabel.font=[UIFont fontWithName:@"Gotham" size:16];
                if(width==320 && height==568){
                    [Button1 setTitleEdgeInsets:UIEdgeInsetsMake(0.0, -55, 0.0, -0.03125*width)];
                }
                else if(width==320 && height==480){
                    Button1.titleLabel.font=[UIFont fontWithName:@"Gotham" size:12];
...
-(IBAction)buttonPressed:(id)sender{
    ...
    if(clicked.tag == 2000){
        ...
        myImageView.image= [UIImage imageNamed:@"ic_lomobile_transit_car_small.png"];
}
else if(clicked.tag==1001){
