...
class managecity: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        if(indexPath.row == 0){
            ...
            cell.segmentedctrl.setWidth(0.12 * self.view.frame.size.width, forSegmentAtIndex: cell.segmentedctrl.numberOfSegments - 2)
            cell.segmentedctrl.setWidth(0.12 * self.view.frame.size.width, forSegmentAtIndex: cell.segmentedctrl.numberOfSegments - 1)
            cell.segmentedctrl.addTarget(self, action: #selector(self.segmentchange(_:)), forControlEvents: UIControlEvents.ValueChanged)
            cell.segmentedctrl.selectedSegmentIndex = 0
            return cell
        }
