...
- (BOOL)updateLabelWithDocument:(PSPDFDocument *)document page:(NSUInteger)page visiblePages:(NSOrderedSet *)visiblePages;
...
- (NSString *)pageLabelWithDocument:(PSPDFDocument *)document page:(NSUInteger)page visiblePages:(NSOrderedSet *)visiblePages;
