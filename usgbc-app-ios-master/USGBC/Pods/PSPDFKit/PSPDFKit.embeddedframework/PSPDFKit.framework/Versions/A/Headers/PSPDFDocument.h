...
*/
@interface PSPDFDocument : NSObject <PSPDFDocumentProviderDelegate, PSPDFOverridable, UIActivityItemSource, NSCopying, NSSecureCoding, NSFastEnumeration>
...
/// You can override this via subclassing the document and overriding the getter.
...
@property (nonatomic, assign, readonly) BOOL canSaveAnnotations;
