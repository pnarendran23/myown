...
class CEActivity {
    ...
    init(json: JSON) {
        ...
        field_ce_course_to_date_value = json["field_ce_course_to_date_value"].stringValue
        ...
        field_ce_url_value = json["field_ce_course_url_value"].stringValue
