//
//  AdvAndPolicyDetailsViewController.swift
//  USGBC
//
...
class AdvAndPolicyDetailsViewController: UIViewController, UIWebViewDelegate {
    ...
    func initWebView() {
        ...
        do {
            guard let filePath = Bundle.main.path(forResource: "advAndPolicyTemplate", ofType: "html", inDirectory: "Web")
                else {
                    // File Error
