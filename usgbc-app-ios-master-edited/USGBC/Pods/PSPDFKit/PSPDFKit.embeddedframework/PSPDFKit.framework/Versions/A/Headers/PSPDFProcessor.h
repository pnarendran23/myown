...
extern NSString *const PSPDFProcessorAnnotationTypesKey;
extern NSString *const PSPDFProcessorAnnotationDictKey;
extern NSString *const PSPDFProcessorAnnotationAsDictionaryKey; // Set to `@YES` to add annotations as dictionary and don't flatten them. Dictionary keys are the *original* page indexes.

// Settings for the string/URL -> PDF generators.
extern NSString *const PSPDFProcessorPageRectKey;         // Defaults to `PSPDFPaperSizeA4`
extern NSString *const PSPDFProcessorNumberOfPagesKey;    // Defaults to 10. Set lower to optimize, higher if you have a lot of content.
extern NSString *const PSPDFProcessorPageBorderMarginKey; // Defaults to `UIEdgeInsetsMake(5, 5, 5, 5)`.
extern NSString *const PSPDFProcessorAdditionalDelayKey;  // Defaults to 0.05 seconds. Set higher if you get blank pages.
extern NSString *const PSPDFProcessorStripEmptyPagesKey;  // Defaults to NO. Adds an additional step to strip white pages if you're getting any at the end.
extern NSString *const PSPDFProcessorSkipPDFCreationKey;  // Defaults to NO. Will assume output is already a valid PDF and just perform annotation saving.
...
extern NSString *const PSPDFProcessorDrawRectBlockKey;
...
// common options
extern NSString *const PSPDFProcessorDocumentTitleKey;    // Will override any defaults if set.
