...
+ (CGFloat)heightForCellWithOutlineElement:(PSPDFOutlineElement *)outlineElement documentProvider:(PSPDFDocumentProvider *)documentProvider constrainedToSize:(CGSize)constraintSize outlineIntentLeftOffset:(CGFloat)leftOffset outlineIntentMultiplier:(CGFloat)multiplier showPageLabel:(BOOL)showPageLabel;
