...
extern NSString *const PSPDFActionOptionModalKey;    // Set to @YES in the options dictionary to make links modal.
extern NSString *const PSPDFActionOptionAutoplayKey; // Enable Autoplay if target is a video.
extern NSString *const PSPDFActionOptionControlsKey; // Enable/Disable controls. (e.g. Browser back/next buttons)
extern NSString *const PSPDFActionOptionLoopKey;     // Loop the video.
extern NSString *const PSPDFActionOptionOffsetKey;   // Set video offset.
extern NSString *const PSPDFActionOptionSizeKey;     // Set modal size.
extern NSString *const PSPDFActionOptionPopoverKey;  // Show as popover.
extern NSString *const PSPDFActionOptionCoverKey;    // Show cover, accepts string path.
extern NSString *const PSPDFActionOptionPageKey;     // The target page.
extern NSString *const PSPDFActionOptionButtonKey;   // Shows a button that activates links.

// Controls if a close button is displayed, when `PSPDFActionOptionButtonKey` is used. Default will be YES.
extern NSString *const PSPDFActionOptionCloseButtonKey;
