...
@class PSPDFMultiDocumentViewController, PSPDFMultiDocumentPDFViewController;
...
/// @note Your subclass needs to be a subclass of `PSPDFMultiDocumentPDFViewController`.
