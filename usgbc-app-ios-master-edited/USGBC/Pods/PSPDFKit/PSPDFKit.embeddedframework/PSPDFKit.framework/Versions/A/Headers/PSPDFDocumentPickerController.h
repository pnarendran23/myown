...
// Internally uses a search display controller. (Access via the `searchDisplayController` property on UIViewController)
// This might change to also use UISearchController in future versions.
