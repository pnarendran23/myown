...
class listofassets: UIViewController, UITableViewDataSource,UITableViewDelegate,UISearchBarDelegate, WCSessionDelegate {
    ...
    override func viewDidLoad() {
        print(UserDefaults.standard.object(forKey: "currentuser"))
        ...
        if(assets["results"]! is NSArray && UserDefaults.standard.object(forKey: "assetdata") != nil){
            ...
            if let httpStatus = response as? HTTPURLResponse, httpStatus.statusCode == 400 {           // check for http errors
                ...
                do {
                    ...
                    DispatchQueue.main.async(execute: {
                        ...
                        //print("Buildings arr",buildingarr)
                        self.filtertable.selectRow(at: IndexPath.init(row: 4, section: 0), animated: true, scrollPosition: UITableViewScrollPosition.none)
