...
class dissatisfaction: UIView {
    ...
    override init(frame: CGRect) {
        ...
        data = UserDefaults.standard.object(forKey: "dissatisfaction") as! [Int]
        if(data2.count==0){
    ...
    func setupLayerFrames(){
        ...
        if let title : CATextLayer = layers["title"] as? CATextLayer{
            title.frame = CGRect(x: 0.0377 * title.superlayer!.bounds.width, y: 0.03708 * title.superlayer!.bounds.height, width: 0.492667 * title.superlayer!.bounds.width, height: 0.03861 * title.superlayer!.bounds.height)
