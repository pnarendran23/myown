...
@IBDesignable class GraphView: UIView {
  ...
  //1 - the properties for the gradient
    ...
    override func draw(_ rect: CGRect) {
        ...
        //5 - create the gradient
        let gradientt = CGGradient(colorsSpace: colorSpaces, colors: colorr as CFArray, locations: colorLocationss)
        
        context!.drawLinearGradient(gradientt!, start: startPoint, end: endPoint, options: CGGradientDrawingOptions(rawValue: UInt32(0)))
