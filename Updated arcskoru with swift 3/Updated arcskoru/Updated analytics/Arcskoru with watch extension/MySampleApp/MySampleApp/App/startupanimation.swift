...
class startupanimation: UIView {
	...
	func setupLayerFrames(){
		...
		if let text : CATextLayer = layers["text"] as? CATextLayer{
			text.frame = CGRect(x: 0.11917 * text.superlayer!.bounds.width, y: 0.80573 * text.superlayer!.bounds.height, width: 0.76167 * text.superlayer!.bounds.width, height: 0.21915 * text.superlayer!.bounds.height)
		}
	...
	func updateLayerValuesForAnimationId(_ identifier: String){
		if identifier == "old"{
			QCMethod.updateValueFromPresentationLayerForAnimation((layers["path"] as! CALayer).animation(forKey: "pathOldAnim"), theLayer:(layers["path"] as! CALayer))
			QCMethod.updateValueFromPresentationLayerForAnimation((layers["oval2"] as! CALayer).animation(forKey: "oval2OldAnim"), theLayer:(layers["oval2"] as! CALayer))
			QCMethod.updateValueFromPresentationLayerForAnimation((layers["path2"] as! CALayer).animation(forKey: "path2OldAnim"), theLayer:(layers["path2"] as! CALayer))
			QCMethod.updateValueFromPresentationLayerForAnimation((layers["path3"] as! CALayer).animation(forKey: "path3OldAnim"), theLayer:(layers["path3"] as! CALayer))
			QCMethod.updateValueFromPresentationLayerForAnimation((layers["text"] as! CALayer).animation(forKey: "textOldAnim"), theLayer:(layers["text"] as! CALayer))
		}
	}
	...
	func oval2PathWithBounds(_ bounds: CGRect) -> UIBezierPath{
