...
class managecity: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if(indexPath.row == 0){
            ...
            cell.segmentedctrl.setWidth(0.12 * self.view.frame.size.width, forSegmentAt: cell.segmentedctrl.numberOfSegments - 2)
            cell.segmentedctrl.setWidth(0.12 * self.view.frame.size.width, forSegmentAt: cell.segmentedctrl.numberOfSegments - 1)
            cell.segmentedctrl.addTarget(self, action: #selector(self.segmentchange(_:)), for: UIControlEvents.valueChanged)
            cell.segmentedctrl.selectedSegmentIndex = 0
            return cell
        }
    ...
    func configurationTextField(_ textField: UITextField!)
    {
        ...
        if let tField = textField {
            ...
            NotificationCenter.default.addObserver(self, selector: #selector(managecity.handleTextFieldTextDidChangeNotification(_:)), name: NSNotification.Name.UITextFieldTextDidChange, object: textField)
