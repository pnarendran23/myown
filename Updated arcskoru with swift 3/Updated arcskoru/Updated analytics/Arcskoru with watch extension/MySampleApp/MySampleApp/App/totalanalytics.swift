    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if(segue.identifier == "gotodetails"){
            ...
            if(currentcategory == "Energy"){
                ...
                v.reductionarr1 = NSMutableArray.init(array:wateremissions)
                    ...
                    do {
                        ...
                        for (key, value) in dict{
                            if((key as AnyObject).contains("Scope2 Raw GHG (mtCO2e/day)")){
                                temp.add("Raw GHG")
                                temp1.add(String(format:"%.2f mtCO2e",dict["Scope2 Raw GHG (mtCO2e/day)"] as! Float
))
                            }else if((key as AnyObject).contains("Temperature adjusted GHG")){
                                temp.add("Adjusted GHG")
                                temp1.add(String(format:"%.2f mtCO2e",dict["Temperature adjusted GHG"] as! Float
                                    ))
                            }else if((key as AnyObject).contains("Adjusted Emissions per Occupant")){
                                temp.add("Adjusted Emissions per Occupant")
                                temp1.add(String(format:"%.2f mtCO2e/person",dict["Adjusted Emissions per Occupant"] as! Float
                                    ))
                            }else if((key as AnyObject).contains("Adjusted Emissions per SF")){
                                temp.add("Adjusted Emissions per Sq.ft")
                                temp1.add(String(format:"%.2f mtCO2e/sq.ft",dict["Adjusted Emissions per SF"] as! Float
                                    ))
                    ...
                    do {
                        ...
                        for (key, value) in dict{
                            if((key as AnyObject).contains("Raw Water Use (gallons/day)")){
                                ...
                                temp1.add(String(format:"%.2f (gallons/day)",dict["Raw Water Use (gallons/day)"] as! Float
                                    ))
                            }else if((key as AnyObject).contains("Operating Hours adjusted Water Use")){
                                temp.add("Adjusted water use")
                                temp1.add(String(format:"%.2f (gallons/person)",dict["Operating Hours adjusted Water Use"] as! Float
                                    ))
                            }else if((key as AnyObject).contains("Adjusted Gallons per SF")){
                                temp.add("Adjusted Gallons per SF")
                                temp1.add(String(format:"%.2f (gallons/sq.ft)",dict["Adjusted Gallons per SF"] as! Float
                                    ))
                    ...
                    do {
                        ...
                        for (k, value) in dict{
                            ...
                            if(key.contains("Generated Waste (lbs per occupant per day)")){
                                ...
                                temp1.add(String(format:"%.2f (lbs/day)",dict["Generated Waste (lbs per occupant per day)"] as! Float
                                    ))
                            }else if(key.contains("Undiverted Waste (lbs per occupant per day)")){
                                temp.add("Undiverted Waste")
                                temp1.add(String(format:"%.2f lbs/day",dict["Undiverted Waste (lbs per occupant per day)"] as! Float
                                    ))
                    ...
                    do {
                        ...
                        for (k, value) in dict{
                            ...
                            if(key.contains("Average Transit CO2e")){
                                ...
                                temp1.add(String(format:"%d%%",Int(dict["Transportation Participation Fraction"] as! Float)
                                    ))
                            }
                    ...
                    do {
                        ...
                        for (k, value) in dict{
                            ...
                            if(key.contains("mean_response")){
                                ...
                                if let s = dict["occupant_satisfaction"] as? Float{
                                    temp1.add(String(format:"%.2f",100.00 * s))
                                }else if let s = dict["occupant_satisfaction"] as? Int{
