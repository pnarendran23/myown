...
class chartview: UIView {
    ...
    func setupLayerFrames(){
        ...
        if let text : CATextLayer = layers["text"] as? CATextLayer{
            text.frame = CGRect(x: 0.11677 * text.superlayer!.bounds.width, y: 0.75833 * text.superlayer!.bounds.height, width: 0.03833 * text.superlayer!.bounds.width, height: 0.03833 * text.superlayer!.bounds.height)
            text.fontSize        = 0.022 * self.frame.size.width
        }
        
        if let text2 : CATextLayer = layers["text2"] as? CATextLayer{
            text2.frame = CGRect(x: 0.11677 * text2.superlayer!.bounds.width, y: 0.685 * text2.superlayer!.bounds.height, width: 0.03833 * text2.superlayer!.bounds.width, height: 0.03833 * text2.superlayer!.bounds.height)
            text2.fontSize        = 0.022 * self.frame.size.width
        }
        
        if let text3 : CATextLayer = layers["text3"] as? CATextLayer{
            text3.frame = CGRect(x: 0.11677 * text3.superlayer!.bounds.width, y: 0.61167 * text3.superlayer!.bounds.height, width: 0.03833 * text3.superlayer!.bounds.width, height: 0.03833 * text3.superlayer!.bounds.height)
            text3.fontSize        = 0.022 * self.frame.size.width
        }
        
        if let text4 : CATextLayer = layers["text4"] as? CATextLayer{
            text4.frame = CGRect(x: 0.11677 * text4.superlayer!.bounds.width, y: 0.53833 * text4.superlayer!.bounds.height, width: 0.03833 * text4.superlayer!.bounds.width, height: 0.03833 * text4.superlayer!.bounds.height)
            text4.fontSize        = 0.022 * self.frame.size.width
        }
        
        if let text5 : CATextLayer = layers["text5"] as? CATextLayer{
            text5.frame = CGRect(x: 0.11677 * text5.superlayer!.bounds.width, y: 0.465 * text5.superlayer!.bounds.height, width: 0.03833 * text5.superlayer!.bounds.width, height: 0.03833 * text5.superlayer!.bounds.height)
            text5.fontSize        = 0.022 * self.frame.size.width
        }
        
        if let text6 : CATextLayer = layers["text6"] as? CATextLayer{
            text6.frame = CGRect(x: 0.11677 * text6.superlayer!.bounds.width, y: 0.39167 * text6.superlayer!.bounds.height, width: 0.03833 * text6.superlayer!.bounds.width, height: 0.03833 * text6.superlayer!.bounds.height)
            text6.fontSize        = 0.022 * self.frame.size.width
        }
        
        if let text7 : CATextLayer = layers["text7"] as? CATextLayer{
            text7.frame = CGRect(x: 0.11677 * text7.superlayer!.bounds.width, y: 0.31833 * text7.superlayer!.bounds.height, width: 0.03833 * text7.superlayer!.bounds.width, height: 0.03833 * text7.superlayer!.bounds.height)
            text7.fontSize        = 0.022 * self.frame.size.width
        }
        
        if let text8 : CATextLayer = layers["text8"] as? CATextLayer{
            text8.frame = CGRect(x: 0.11677 * text8.superlayer!.bounds.width, y: 0.245 * text8.superlayer!.bounds.height, width: 0.03833 * text8.superlayer!.bounds.width, height: 0.03833 * text8.superlayer!.bounds.height)
            text8.fontSize        = 0.022 * self.frame.size.width
        }
        
        if let text9 : CATextLayer = layers["text9"] as? CATextLayer{
            text9.frame = CGRect(x: 0.11677 * text9.superlayer!.bounds.width, y: 0.17167 * text9.superlayer!.bounds.height, width: 0.03833 * text9.superlayer!.bounds.width, height: 0.03833 * text9.superlayer!.bounds.height)
            text9.fontSize        = 0.022 * self.frame.size.width
        }
        
        if let text10 : CATextLayer = layers["text10"] as? CATextLayer{
            text10.frame = CGRect(x: 0.11677 * text10.superlayer!.bounds.width, y: 0.09833 * text10.superlayer!.bounds.height, width: 0.03833 * text10.superlayer!.bounds.width, height: 0.03833 * text10.superlayer!.bounds.height)
